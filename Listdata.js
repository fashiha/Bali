...
function Callapi() {
    const jsonUrl = 'https://script.google.com/macros/s/AKfycbwA48GRdTUWmAsoUzwrJYgByMMZDLCPieiKGYiK0aC6qTGffiR0Vrr90J_u17iygyrFvw/exec';
                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={styles.card}>
                                        ...
                                        <View>
                                            ...
                                            <Text style={styles. wrappedText}>Harga:{item.harga}</Text>
                                            <Text style={styles. wrappedText}>Rating:{item.rating}</Text>
