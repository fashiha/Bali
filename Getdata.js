...
const styles = StyleSheet.create({
    ...
    avatar: {
        borderRadius: 100,
        width: 80, // panjang gambar 80 piksel sehingga ada jarang antara gambar dan tulisan
    },
    cardtitle: {
        fontSize: 15,
        fontWeight: 'bold',
    ...
    card: {
        flexDirection: 'row', //untuk tampilannya klo dihapus brarti daiatas
        padding: 20, //jarak yang didalam 
        borderRadius: 10,
        ...
        shadowRadius: 1.41,
        elevation: 2,
        marginHorizontal: 20, // jarak kanan kiri 
        marginVertical: 7 // jarak atas bawah
    },
    form: {
